...
const Article = ({ article }) => {
    ...
    return (
        <div className="article" style={{ background: isEditing ? "#f3feff" : "white" }}>
            ...
            {
                isEditing ? <textarea autoFocus defaultValue={editContent ? editContent : article.content} onChange={(e) => setEditContent(e.target.value)}></textarea> : <p>{editContent ? editContent : article.content}</p>
            }
